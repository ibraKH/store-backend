...
const resetRecords = async () => {
    ...
    const reset = await conn.query("SET session_replication_role = 'replica';DELETE FROM product cascade;DELETE FROM users cascade;DELETE FROM orders cascade;SET session_replication_role = 'origin';");
    conn.release();
};
